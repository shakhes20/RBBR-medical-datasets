...
> The raw CSV is **bundled directly in this repo** at
> `data/raw/lung_cancer_examples.csv`, so no download is needed to run
> this example — clone the repo and run the script. See the Kaggle
> source link above for the dataset's original license/redistribution
> terms.
